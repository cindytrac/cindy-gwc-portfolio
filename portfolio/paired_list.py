...
def prime():
    (number%2 and number%5 and number%3 and number%7) != 0

if Mult5():
    print ("the number" + number + " is a multiple of 5." )
if prime():
    print ("The number" + number + "is prime")


#lv 2 - sum of mult of 3 and 5
#count = 0
...
#lv 3 - sum of all primes



#lv 1 - print all mult of five
#for i in random_numbers:
